...
class BitForcesNotificationDiscordWebhook extends BitForcesNotification {
  protected     $receiver;
...
BitForcesNotification::add('Discord Webhook', new BitForcesNotificationDiscordWebhook());
