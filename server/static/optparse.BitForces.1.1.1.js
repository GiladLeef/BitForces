...
// =======================================================================================
// Custom BitForces-specific Filters
// =======================================================================================
...
// Functions
// =======================================================================================
function startParse(cmd, isBitForces = true) {
	...
	if(isBitForces) {
		...
		try {
			parser.parse(args);
			result = validateBitForcesCommand(options);
		} catch (e) {
...
function validateBitForcesCommand(opt) {
	// Pre-case Check
	if(opt.posArgs[0] != '#HL#') {
