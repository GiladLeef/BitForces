...
class DConfig {
  ...
  public static function getConfigDescription($config) {
    switch ($config) {
      ...
      case DConfig::MULTICAST_ENABLE:
        return "Enable UDP multicast distribution of files to agents. (Make sure you did all the preparation before activating)<br>You can read more informations here: <a href='https://github.com/GiladLeef/BitForces/blob/main/README.md' target='_blank'>https://github.com/GiladLeef/BitForces</a>";
      case DConfig::MULTICAST_DEVICE:
